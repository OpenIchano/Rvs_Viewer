...
@property (nonatomic, assign) NSUInteger AppID; //获取采集端appid
...
- (NSInteger)setOldIPCAlarmWithStreamer:(unsigned long long)streamerCID
                              EmailFlag:(int)emailFlag
                             EmailAddre:(NSString*)emailAddr
                               PushFlag:(int)pushFlag
                           MotionStatus:(int)motionStatus
                      MotionSensitivity:(int)motionSensitivity
                              AlarmSet1:(int)alarmSet1
                              AlarmSet2:(int)alarmSet2
                              AlarmSet3:(int)alarmSet3;
